...
-------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    --putStrLn $ show $ evalApplicableRules (Not (p :||: Not q) :&&: ((Not (Not p) :||: Not (Not (Not q))) :||: Not r)) (applicableRules (Not (p :||: Not q) :&&: Not (Not (p :||: Not q) :&&: r)))
    --putStrLn $ show $ evalApplicableRules (Not (Not q :||: p) :&&: ((Not (Not p) :||: Not (Not (Not q))) :||: Not r)) (applicableRules (Not (p :||: Not q) :&&: Not (Not (p :||: Not q) :&&: r)))
    --putStrLn $ show $ evalApplicableRules (Not (p :||: Not q) :&&: ((Not r :||: Not (Not (Not q))) :||: Not (Not p))) (applicableRules (Not (p :||: Not q) :&&: Not (Not (p :||: Not q) :&&: r)))
